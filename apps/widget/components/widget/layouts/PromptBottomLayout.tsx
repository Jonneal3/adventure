...
export function PromptBottomLayout({
  ...
  instanceId,
  onGenerateGallery,
  onResetToSampleGallery, // Add this parameter
  onPromptSubmit,
  onDrillDownSubmit,
  onSuggestionClick,
  onImageUpload,
  ...
  // NOTE: PromptBottomLayout uses a ChatGPT-like "composer" in `UserInputSection`
  // that already owns background/border/shadow. Keeping an additional outer
  // panel here creates a visible "outside area" around the input.
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          bottom: allowUnderScroll ? 0 : undefined,
          zIndex: promptZ,
        }}
      >
        <motion.div
          ...
          style={{
            ...
            height: "100%",
            maxHeight: "100%",
            // Let the inner composer be the only visible surface.
