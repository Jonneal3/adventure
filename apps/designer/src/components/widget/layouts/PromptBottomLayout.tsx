  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="absolute inset-0 overflow-auto" style={{
        paddingBottom: `${Math.max(5, 10 * heightScaleFactor)}vh`,
      ...
      <div className={`absolute bottom-0 left-0 right-0 z-10 flex ${getAlignmentClass(config.prompt_section_alignment || 'center')}`} style={{
        ...
        <div 
          ...
          style={{ 
            ...
            margin: `${Math.max(1, 2 * heightScaleFactor)}px`,
