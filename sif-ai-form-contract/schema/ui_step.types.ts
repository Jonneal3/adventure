// Stable re-export path for the AI Form UI contract types.
//
// The actual contract snapshot is versioned under `shared/ai-form-ui-contract.bak-*/`.
// Vercel builds (and any fresh clone) rely on this stable import path:
//   "@/shared/ai-form-ui-contract/schema/ui_step.types"
//
// If you update the contract snapshot folder, update the import below accordingly.

export * from "../../ai-form-ui-contract.bak-20260109122528/schema/ui_step.types";
...
// Minimal "review" step appended at the end of the last batch.
// Intentionally does NOT require `question` (backend usually provides it, but UI should not crash if omitted).
